...
class Elastic_Slide_Loader {
     ...
     */
    public static function elastic_slider_get_template($slug, $name = null, $load = true) {
        ...
        return Elastic_Slide_Loader::elastic_slider_locate_template($templates, $load, false);
    }
     ...
     */
    public static function elastic_slider_locate_template($template_names, $load = false, $require_once = true) {
        // No file found yet
        $located = false;
        ...
        foreach ((array) $template_names as $template_name) {
            ...
            } elseif (file_exists(trailingslashit(Elastic_Slide_Loader::elastic_slider_get_templates_dir()) . $template_name)) {
                $located = trailingslashit(Elastic_Slide_Loader::elastic_slider_get_templates_dir()) . $template_name;
                break;
            }
        }
